...
// 设置整体内容的尺寸
- (void)setUpTitleScrollViewFrame:(void (^)(UIScrollView *))titleScrollViewBlock
{
    if (titleScrollViewBlock) {
        titleScrollViewBlock(self.titleScrollView);
    }
}
...
- (void)viewDidLayoutSubviews
{
    ...
    if (_isInitial == NO) {
        ...
        //自己添加的方法 by lxk
        if (self.titleScrollViewBlock) {
            self.titleScrollViewBlock(self.titleScrollView);
        }
